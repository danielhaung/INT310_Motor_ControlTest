    ...
    try:
        while True:
            ...
            if len(resp) >= 19 and resp[0] == SLAVE_ID and resp[1] == 0x03 and resp[2] >= 14:
                ...
                LX = u16_to_s16(regs[3]) / 100.0  # D24
                LY = u16_to_s16(regs[4]) / 100.0  # D25
                RX = u16_to_s16(regs[5]) / 100.0  # D26
                RY = u16_to_s16(regs[6]) / 100.0  # D27

                line = f"D21=0x{d21:04X} (b7={b7}, b4={b4}) | " \
